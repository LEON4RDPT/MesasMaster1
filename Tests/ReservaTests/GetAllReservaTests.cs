...
public class GetAllReservaTests
{
    ...
    public GetAllReservaTests()
    {
        ...
        _handler = new GetAllReservaHandler(_context);
    ...
    [Fact]
    public async Task Should_Return_All_Reservas()
    {
    ...
    [Fact]
    public async Task Should_Return_Empty_Reservas_Already_Done()
    {
        var user1 = await AddTestUser();
        var user2 = await AddTestUser();
        var mesa = await AddTestMesa(2, 0, 0, 120);
        ...
        {
            DataInicio = DateTime.Now.AddMinutes(-20),
            DataFim = DateTime.Now.AddMinutes(-10),
            User = user1,
            Mesa = mesa,
            Ativa = false,
        });
